...
const PurchaseView: React.FC<PurchaseViewProps> = ({ onBack, onSuccess }) => {
  ...
  const handlePayment = (url: string) => {
    if (url === "#") {
      alert("Cette option de paiement arrive très prochainement. Veuillez privilégier les options disponibles.");
      return;
    }
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter mb-4 italic serif-font leading-none">
            Rejoignez <span className="text-[#ff0000] text-glow">le Clan Pulse Noir</span>.
          </h1>
          <p className="text-gray-400 text-lg md:text-xl italic font-light max-w-2xl mx-auto mb-10">
            Accès immédiat à l'opération stratégique : <br/>
            <span className="text-white font-black">"Intervention AUTEUR INVISIBLE : Pourquoi votre polar ne se vend pas (et comment y remédier)"</span>
          </p>
          ...
          <div className="max-w-3xl mx-auto mb-16 bg-[#ff0000]/10 border border-[#f4c024]/30 rounded-[2.5rem] p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden group">
            ...
            <div className="text-center md:text-left relative z-10">
              <p className="text-[#f4c024] font-black uppercase text-[10px] tracking-[0.3em] mb-1 italic">OFFERT : ACCOMPAGNEMENT INDIVIDUEL</p>
              <p className="text-white font-bold text-lg italic leading-snug">
                Votre session de diagnostic chirurgical d'une heure <span className="text-[#f4c024]">(Valeur 150€)</span> est <span className="underline decoration-[#f4c024] underline-offset-4">INCLUSE</span>. C'est votre levier anti-erreur pour valider votre système de relance.
              </p>
              <p className="text-gray-500 text-[10px] mt-2 font-black uppercase tracking-widest italic">* Limité aux 10 premiers inscrits (validé par l'ordre des transactions)</p>
            </div>
          </div>
        </header>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto items-center">
          ...
          <div className="bg-neutral-950 border border-white/10 rounded-[3rem] p-8 relative overflow-hidden flex flex-col group hover:border-[#ff0000]/30 transition-all lg:h-[90%]">
            ...
            <div className="mb-8">
              ...
              <p className="text-[9px] text-gray-500 font-black uppercase tracking-widest mt-2">Pendant 2 mois (310€ total)</p>
            </div>

            <div className="space-y-4 mb-10 flex-1">
              {[
                "Accès complet dès le 1er versement",
                "Diagnostic Privé (si places dispo)",
                "Tous les instruments de correction",
                "Idéal pour investir avec souplesse",
                "Prélèvement automatique sécurisé"
              ].map((benefit, i) => (
          ...
          <div className="bg-neutral-900 border-2 border-[#f4c024] rounded-[3rem] p-10 relative overflow-hidden flex flex-col shadow-[0_0_50px_rgba(244,192,36,0.3)] group scale-105 z-20 transition-all lg:h-full">
            ...
            <div className="mb-8">
              ...
              <p className="text-[10px] text-[#f4c024] font-black uppercase tracking-widest mt-2">Économisez 30€ sur votre relance</p>
            </div>

            <div className="space-y-4 mb-10 flex-1">
              {[
                "Accès prioritaire au Coaching (si places)",
                "Intervention débloquée à vie",
                "Le Pack d'Instruments complet",
                "Mises à jour stratégiques incluses",
          ...
          <div className="bg-neutral-950 border border-white/10 rounded-[3rem] p-8 relative overflow-hidden flex flex-col group hover:border-[#ff0000]/30 transition-all lg:h-[90%]">
            ...
            <div className="mb-8">
              ...
              <p className="text-[9px] text-gray-500 font-black uppercase tracking-widest mt-2">Pendant 3 mois (327€ total)</p>
            </div>

            <div className="space-y-4 mb-10 flex-1">
              {[
                "La mensualité la plus accessible",
                "Accès au groupe privé du Clan Pulse Noir",
                "Tous les outils inclus d'emblée",
                "Accès illimité à l'espace membre",
                "Gestion Stripe 100% sécurisée"
              ].map((benefit, i) => (
                <div key={i} className="flex gap-3 items-center">
                  <CheckCircle2 size={14} className="text-gray-700 shrink-0" />
                  <span className="text-[10px] font-bold uppercase tracking-wide text-gray-400 italic">{benefit}</span>
        ...
        <div className="mt-20 flex flex-col items-center gap-8">
          <div className="flex flex-wrap justify-center items-center gap-12 text-gray-600">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[9px] font-black uppercase tracking-widest">Sécurisé par Stripe</span>
            </div>
            <div className="flex items-center gap-3">
